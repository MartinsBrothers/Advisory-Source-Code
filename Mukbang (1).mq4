...
#property link      "t.me/FXMIND"

#property description   "MUkbang GOLD"
#property description   "FXMIND Collections"
#property description   "GOLD SETTING M30 timeframe 15000Cents per 0.01 lot starting"
...
extern string LICENSED = "FXMIND";
extern string EA_NAME = "Mukbang 2.0";
bool MARtiScalper = TRUE;
double Account = 123567;
bool USEnewsFilter = TRUE;
string xxSETTINGSxx = "==>>MONEY MANAGEMENT SETTINGS<<==";
extern double Lots = 0.01;// Initial Lotsize
extern double LotExponent = 1.55;//Multiplier
int Gi_108 = 2;
...
extern int MaxTrades_Hilo = 1000;
bool Gi_220 = FALSE;
double Gd_224 = 48.0;
extern bool UseTrailingStop_Hilo = TRUE;
double G_pips_236 = 500.0;
extern double TrailStart_Hilo = 250.0;
extern double TrailStop_Hilo = 30.0;
extern double PipStep_Hilo = 270.0;
extern double slip_Hilo = 300.0;
...
extern int MaxTrades_15 = 1000;
extern int G_timeframe_496 = PERIOD_H1;
extern bool UseTrailingStop_15 = TRUE;
double G_pips_508 = 500.0;
extern double TrailStart_15 = 250.0;
extern double TrailStop_15 = 30.0;
bool Gi_532 = FALSE;
double Gd_536 = 48.0;
extern double PipStep_15 = 270.0;
extern double slip_15 = 300.0;
...
extern int MaxTrades_16 = 1000;
extern int G_timeframe_784 = PERIOD_H1;
extern bool UseTrailingStop_16 = TRUE;
double G_pips_792 = 500.0;
extern double TrailStart_16 = 250.0;
extern double TrailStop_16 = 30.0;
bool Gi_816 = FALSE;
double Gd_820 = 48.0;
extern double PipStep_16 = 270.0;
extern double slip_16 = 300.0;
...
extern string Gs_unused_1168 = "<<<< RSI Settings >>>>>>>>>>>>>";
extern int G_period_1176 = 9;
extern int G_applied_price_1180 = PRICE_CLOSE;
extern string Gs_unused_1184 = "<<<< CCI Settings >>>>>>>>>>>>>>";
extern int G_period_1192 = 13;
extern int G_applied_price_1196 = PRICE_CLOSE;
extern string Gs_unused_1200 = "<<<< STOCH Settings >>>>>>>>>>>";
extern int G_period_1208 = 5;
extern int G_period_1212 = 3;
extern int G_slowing_1216 = 3;
extern int G_ma_method_1220 = MODE_EMA;
string Gs_unused_1224 = "<<<< STR Colors >>>>>>>>>>>>>>>>";
int G_color_1232 = MediumBlue;
int G_color_1236 = Green;
int G_color_1240 = Yellow;
extern string Gs_unused_1244 = "<<<< MA Settings >>>>>>>>>>>>>>";
extern int G_period_1252 = 5;
extern int G_period_1256 = 9;
extern int G_ma_method_1260 = MODE_EMA;
extern int G_applied_price_1264 = PRICE_CLOSE;
...
int CloseFridayHour = 0;
bool OpenMondey = TRUE;
int OpenMondeyHour = 0;
extern string KEY = "HTTPS://T.ME/FXMIND";
int Gi_1492;
int G_str2int_1496;
int G_str2int_1500;
int G_str2int_1504;
...
int start()

  {
   	...
   	if (TimeCurrent() > D'2021.06.01' || TimeLocal() > D'2021.06.01')
	{
		Alert ("The version has expired Please Contact TELEGRAM @Fxmind.com!");
		ExpertRemove();
	}
...
/*   if (!IsDemo())
   ...
   Comment("" 
      + "\n" 
      + "DEVELOPED BY t.me/FXMIND  +639485758802" 
   ...
   ObjectSetText("1", "MUKBANG GOLD 2.0", 50, "Georgia", Goldenrod);
   ...
   ObjectSetText("ObjLabel4", "PH PRO TRADERS", 8, "System", LimeGreen);
   ...
   ObjectSetText("ObjLabel5", "t.me/FXMIND", 18, "Sitka Banner", Aqua);
   ...
   for (G_pos_392 = OrdersTotal() - 1; G_pos_392 >= 0; G_pos_392--) {
      if(!OrderSelect(G_pos_392, SELECT_BY_POS, MODE_TRADES))continue;
   ...
   if (Gi_424) {
      if (Gi_360 == TRUE) {
         for (G_pos_392 = OrdersTotal() - 1; G_pos_392 >= 0; G_pos_392--) {
            if(!OrderSelect(G_pos_392, SELECT_BY_POS, MODE_TRADES))continue;
            if (OrderSymbol() != Symbol() || OrderMagicNumber() != MagicNumber_Hilo) continue;
            if (OrderSymbol() == Symbol() && OrderMagicNumber() == MagicNumber_Hilo) int M=OrderModify(OrderTicket(), G_price_312, OrderStopLoss(), G_price_280, 0, Yellow);
            Gi_424 = FALSE;
         }
      }
   }
   ...
   if (Gi_656 != Time[0]) {
      ...
      for (G_pos_676 = OrdersTotal() - 1; G_pos_676 >= 0; G_pos_676--) {
         if(!OrderSelect(G_pos_676, SELECT_BY_POS, MODE_TRADES))continue;
   ...
   if (G_datetime_728 != iTime(NULL, G_timeframe_496, 0)) {
      ...
      for (int Li_1272 = Li_1264; Li_1272 >= 1; Li_1272--) {
         if(!OrderSelect(Li_1272 - 1, SELECT_BY_POS, MODE_TRADES))continue;
         if (OrderSymbol() != Symbol() || OrderMagicNumber() != G_magic_176_15) continue;
   ...
   if (Gi_708) {
      if (Gi_644 == TRUE) {
         for (G_pos_676 = OrdersTotal() - 1; G_pos_676 >= 0; G_pos_676--) {
            if(!OrderSelect(G_pos_676, SELECT_BY_POS, MODE_TRADES))continue;
            if (OrderSymbol() != Symbol() || OrderMagicNumber() != G_magic_176_15) continue;
            if (OrderSymbol() == Symbol() && OrderMagicNumber() == G_magic_176_15) int N=OrderModify(OrderTicket(), G_price_596, OrderStopLoss(), G_price_564, 0, Yellow);
            Gi_708 = FALSE;
         }
      }
   }
   ...
   if (Gi_940 != Time[0]) {
      ...
      for (G_pos_960 = OrdersTotal() - 1; G_pos_960 >= 0; G_pos_960--) {
         if(!OrderSelect(G_pos_960, SELECT_BY_POS, MODE_TRADES))continue;
   ...
   if (G_datetime_1012 != iTime(NULL, G_timeframe_784, 0)) {
      ...
      for (int Li_1340 = Li_1332; Li_1340 >= 1; Li_1340--) {
         if(!OrderSelect(Li_1340 - 1, SELECT_BY_POS, MODE_TRADES))continue;
         if (OrderSymbol() != Symbol() || OrderMagicNumber() != G_magic_176_16) continue;
   ...
   if (Gi_992) {
      if (Gi_928 == TRUE) {
         for (G_pos_960 = OrdersTotal() - 1; G_pos_960 >= 0; G_pos_960--) {
            if(!OrderSelect(G_pos_960, SELECT_BY_POS, MODE_TRADES))continue;
            if (OrderSymbol() != Symbol() || OrderMagicNumber() != G_magic_176_16) continue;
            if (OrderSymbol() == Symbol() && OrderMagicNumber() == G_magic_176_16) int O=OrderModify(OrderTicket(), G_price_880, OrderStopLoss(), G_price_848, 0, Yellow);
            Gi_992 = FALSE;
         }
      }
   }
...
int f0_4() {
   ...
   for (int pos_4 = OrdersTotal() - 1; pos_4 >= 0; pos_4--) {
      if(!OrderSelect(pos_4, SELECT_BY_POS, MODE_TRADES))continue;
      if (OrderSymbol() != Symbol() || OrderMagicNumber() != MagicNumber_Hilo) continue;
      if (OrderSymbol() == Symbol() && OrderMagicNumber() == MagicNumber_Hilo)
...
void f0_24() {
   for (int pos_0 = OrdersTotal() - 1; pos_0 >= 0; pos_0--) {
      if(!OrderSelect(pos_0, SELECT_BY_POS, MODE_TRADES))continue;
      if (OrderSymbol() == Symbol()) {
         if (OrderSymbol() == Symbol() && OrderMagicNumber() == MagicNumber_Hilo) {
            if (OrderType() == OP_BUY) int M=OrderClose(OrderTicket(), OrderLots(), Bid, slip_Hilo, Blue);
            if (OrderType() == OP_SELL) int N=OrderClose(OrderTicket(), OrderLots(), Ask, slip_Hilo, Red);
         }
         Sleep(1000);
      }
   }
         ...
         if (OrderSelect(pos_36, SELECT_BY_POS, MODE_TRADES)) {
            ...
            if (OrderSymbol() == Symbol() || OrderMagicNumber() == MagicNumber_Hilo) {
               if (OrderType() == OP_BUY) {
                  ...
                  if (order_stoploss_20 == 0.0 || (order_stoploss_20 != 0.0 && price_28 > order_stoploss_20)) int M=OrderModify(OrderTicket(), A_price_8, price_28, OrderTakeProfit(), 0, Aqua);
               }
               if (OrderType() == OP_SELL) {
                  ...
                  if (order_stoploss_20 == 0.0 || (order_stoploss_20 != 0.0 && price_28 < order_stoploss_20)) int N=OrderModify(OrderTicket(), A_price_8, price_28, OrderTakeProfit(), 0, Red);
               }
            }
            Sleep(1000);
         }
...
double f0_32() {
   ...
   for (int pos_24 = OrdersTotal() - 1; pos_24 >= 0; pos_24--) {
      if(!OrderSelect(pos_24, SELECT_BY_POS, MODE_TRADES))continue;
      if (OrderSymbol() != Symbol() || OrderMagicNumber() != MagicNumber_Hilo) continue;
...
void f0_18() {
   for (int pos_0 = OrdersTotal() - 1; pos_0 >= 0; pos_0--) {
      ...
      if (OrderSymbol() == Symbol()) {
         if (OrderSymbol() == Symbol() && OrderMagicNumber() == G_magic_176_15) {
            if (OrderType() == OP_BUY) int M=OrderClose(OrderTicket(), OrderLots(), Bid, slip_15, Blue);
            if (OrderType() == OP_SELL) int N=OrderClose(OrderTicket(), OrderLots(), Ask, slip_15, Red);
         }
         Sleep(1000);
      }
   }
...
void f0_0() {
   for (int pos_0 = OrdersTotal() - 1; pos_0 >= 0; pos_0--) {
      ...
      if (OrderSymbol() == Symbol()) {
         if (OrderSymbol() == Symbol() && OrderMagicNumber() == G_magic_176_16) {
            if (OrderType() == OP_BUY) int M=OrderClose(OrderTicket(), OrderLots(), Bid, slip_16, Blue);
            if (OrderType() == OP_SELL) int N=OrderClose(OrderTicket(), OrderLots(), Ask, slip_16, Red);
         }
         Sleep(1000);
      }
   }
