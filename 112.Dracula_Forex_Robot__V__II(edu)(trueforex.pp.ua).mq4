//+------------------------------------------------------------------+
//|         112.Dracula_Forex_Robot__V__II(edu)(trueforex.pp.ua).mq4 |
...
string gs_unused_1960 = "2008.05.01";
int gi_1968 = 0;
bool gi_1972 = FALSE;
int gi_1976 = 0;
int gi_1980 = 0;
...
void hidden_take_profit() {
   ...
   for (int pos_8 = order_total_4 - 1; pos_8 >= 0; pos_8--) {
      ...
      if (OrderSymbol() == Symbol()) {
         if (OrderType() == OP_BUY && OrderOpenPrice() + hidden_tp * Point <= Bid) is_closed_0 = OrderClose(OrderTicket(), OrderLots(), MarketInfo(OrderSymbol(), MODE_BID), 5, Red);
         if (OrderType() == OP_SELL && OrderOpenPrice() - hidden_tp * Point >= Ask) is_closed_0 = OrderClose(OrderTicket(), OrderLots(), MarketInfo(OrderSymbol(), MODE_ASK), 5, Red);
      }
   }
}
...
void hidden_stop_loss() {
   ...
   for (int pos_8 = order_total_4 - 1; pos_8 >= 0; pos_8--) {
      ...
      is_closed_0 = FALSE;
      if (OrderSymbol() == Symbol()) {
         if (OrderType() == OP_BUY && OrderOpenPrice() - hidden_sl * Point >= Bid) is_closed_0 = OrderClose(OrderTicket(), OrderLots(), MarketInfo(OrderSymbol(), MODE_BID), 5, Red);
         if (OrderType() == OP_SELL && OrderOpenPrice() + hidden_sl * Point <= Ask) is_closed_0 = OrderClose(OrderTicket(), OrderLots(), MarketInfo(OrderSymbol(), MODE_ASK), 5, Red);
      }
   }
}
...
void scale_take_profit() {
   ...
   for (int pos_8 = order_total_4 - 1; pos_8 >= 0; pos_8--) {
      ...
      is_closed_0 = FALSE;
      if (OrderSymbol() == Symbol()) {
         if (OrderType() == OP_BUY && OrderOpenPrice() + gi_1508 * Point <= Bid) is_closed_0 = OrderClose(OrderTicket(), OrderLots() / 3.0, MarketInfo(OrderSymbol(), MODE_BID), 5, Red);
         if (OrderType() == OP_SELL && OrderOpenPrice() - gi_1508 * Point >= Ask) is_closed_0 = OrderClose(OrderTicket(), OrderLots() / 3.0, MarketInfo(OrderSymbol(), MODE_ASK), 5, Red);
      }
   }
}
...
void scale_take_profit2() {
   ...
   for (int pos_8 = order_total_4 - 1; pos_8 >= 0; pos_8--) {
      ...
      is_closed_0 = FALSE;
      if (OrderSymbol() == Symbol()) {
         if (OrderType() == OP_BUY && OrderOpenPrice() + gi_1512 * Point <= Bid) is_closed_0 = OrderClose(OrderTicket(), OrderLots() / 2.0, MarketInfo(OrderSymbol(), MODE_BID), 5, Red);
         if (OrderType() == OP_SELL && OrderOpenPrice() - gi_1512 * Point >= Ask) is_closed_0 = OrderClose(OrderTicket(), OrderLots() / 2.0, MarketInfo(OrderSymbol(), MODE_ASK), 5, Red);
      }
   }
}
...
void scale_take_profit3() {
   ...
   for (int pos_8 = order_total_4 - 1; pos_8 >= 0; pos_8--) {
      ...
      is_closed_0 = FALSE;
      if (OrderSymbol() == Symbol()) {
         if (OrderType() == OP_BUY && OrderOpenPrice() + gi_1516 * Point <= Bid) is_closed_0 = OrderClose(OrderTicket(), OrderLots(), MarketInfo(OrderSymbol(), MODE_BID), 5, Red);
         if (OrderType() == OP_SELL && OrderOpenPrice() - gi_1516 * Point >= Ask) is_closed_0 = OrderClose(OrderTicket(), OrderLots(), MarketInfo(OrderSymbol(), MODE_ASK), 5, Red);
      }
   }
}
...
void scale_stop_loss() {
   ...
   for (int pos_8 = order_total_4 - 1; pos_8 >= 0; pos_8--) {
      ...
      is_closed_0 = FALSE;
      if (OrderSymbol() == Symbol()) {
         if (OrderType() == OP_BUY && OrderOpenPrice() - gi_1488 * Point >= Bid) is_closed_0 = OrderClose(OrderTicket(), OrderLots() / 3.0, MarketInfo(OrderSymbol(), MODE_BID), 5, Red);
         if (OrderType() == OP_SELL && OrderOpenPrice() + gi_1488 * Point <= Ask) is_closed_0 = OrderClose(OrderTicket(), OrderLots() / 3.0, MarketInfo(OrderSymbol(), MODE_ASK), 5, Red);
      }
   }
}
...
void scale_stop_loss2() {
   ...
   for (int pos_8 = order_total_4 - 1; pos_8 >= 0; pos_8--) {
      ...
      is_closed_0 = FALSE;
      if (OrderSymbol() == Symbol()) {
         if (OrderType() == OP_BUY && OrderOpenPrice() - gi_1492 * Point >= Bid) is_closed_0 = OrderClose(OrderTicket(), OrderLots() / 2.0, MarketInfo(OrderSymbol(), MODE_BID), 5, Red);
         if (OrderType() == OP_SELL && OrderOpenPrice() + gi_1492 * Point <= Ask) is_closed_0 = OrderClose(OrderTicket(), OrderLots() / 2.0, MarketInfo(OrderSymbol(), MODE_ASK), 5, Red);
      }
   }
}
...
void scale_stop_loss3() {
   ...
   for (int pos_8 = order_total_4 - 1; pos_8 >= 0; pos_8--) {
      ...
      is_closed_0 = FALSE;
      if (OrderSymbol() == Symbol()) {
         if (OrderType() == OP_BUY && OrderOpenPrice() - gi_1496 * Point >= Bid) is_closed_0 = OrderClose(OrderTicket(), OrderLots(), MarketInfo(OrderSymbol(), MODE_BID), 5, Red);
         if (OrderType() == OP_SELL && OrderOpenPrice() + gi_1496 * Point <= Ask) is_closed_0 = OrderClose(OrderTicket(), OrderLots(), MarketInfo(OrderSymbol(), MODE_ASK), 5, Red);
      }
   }
}
...
void Closepending() {
   ...
   for (int pos_8 = order_total_4 - 1; pos_8 >= 0; pos_8--) {
      ...
      is_deleted_0 = FALSE;
      if (OrderSymbol() == Symbol())
         if (OrderType() > OP_SELL) is_deleted_0 = OrderDelete(OrderTicket());
   }
}
   ...
   for (int pos_8 = order_total_4 - 1; pos_8 >= 0; pos_8--) {
      ...
      if (OrderSymbol() == Symbol()) {
         if (OrderProfit() == (-gi_1244) * LotsOptimized())
            if (OrderType() == OP_BUY) is_closed_0 = OrderClose(OrderTicket(), OrderLots(), MarketInfo(OrderSymbol(), MODE_BID), 5, Red);
      }
   }
}
...
void Closeshortsinprofit() {
   ...
   for (int pos_8 = order_total_4 - 1; pos_8 >= 0; pos_8--) {
      ...
      if (OrderSymbol() == Symbol()) {
         if (OrderProfit() == (-gi_1244) * LotsOptimized())
            if (OrderType() == OP_SELL) is_closed_0 = OrderClose(OrderTicket(), OrderLots(), MarketInfo(OrderSymbol(), MODE_ASK), 5, Red);
      }
   }
}
...
void mClose_target() {
   ...
   for (int pos_8 = order_total_4 - 1; pos_8 >= 0; pos_8--) {
      ...
      if (OrderSymbol() == Symbol() && OrderMagicNumber() == 99) {
         if (OrderSymbol() == Symbol() && OrderType() == OP_BUY) is_closed_0 = OrderClose(OrderTicket(), OrderLots(), MarketInfo(OrderSymbol(), MODE_BID), 5, Red);
         if (OrderSymbol() == Symbol() && OrderType() == OP_SELL) is_closed_0 = OrderClose(OrderTicket(), OrderLots(), MarketInfo(OrderSymbol(), MODE_ASK), 5, Red);
         RefreshRates();
...
void Closeprofit() {
   ...
   for (int pos_8 = order_total_4 - 1; pos_8 >= 0; pos_8--) {
      ...
      is_closed_0 = FALSE;
      if (OrderSymbol() == Symbol()) {
         if (OrderProfit() > 0.0 && OrderSymbol() == Symbol() && OrderType() == OP_BUY) is_closed_0 = OrderClose(OrderTicket(), OrderLots(), MarketInfo(OrderSymbol(), MODE_BID), 5, Red);
         if (OrderProfit() > 0.0 && OrderSymbol() == Symbol() && OrderType() == OP_SELL) is_closed_0 = OrderClose(OrderTicket(), OrderLots(), MarketInfo(OrderSymbol(), MODE_ASK), 5, Red);
      }
   }
}
...
void breakeven() {
   ...
   if ((pricefilter && close_16 > iclose_96 + 110.0 * gd_664) || (patternsfilter && (iclose_56 >= iclose_64 && iclose_56 >= iclose_72 && iopen_184 > iclose_80 && iclose_88 > iopen_192 &&
      ...
      ihigh_288 < ihigh_280 && ihigh_280 < ihigh_272 && ihigh_272 > ihigh_264 && ilow_432 < ilow_424 && ilow_424 > ilow_416 && ilow_416 < ilow_408 && ilow_408 < ilow_400 &&
      ilow_400 > ilow_392 && ilow_392 < ilow_384 && ilow_384 < ilow_376 && ilow_376 > ilow_368) || (iclose_120 < iopen_224 && iclose_112 > iopen_216 && iclose_104 > iopen_208 && iclose_96 >= iopen_200 && iclose_88 > iopen_192 && iclose_80 > iopen_184 && iclose_72 < iopen_176 && iclose_64 > iopen_168 && iclose_56 > iopen_160 && ihigh_328 < ihigh_320 && ihigh_320 < ihigh_312 && ihigh_312 < ihigh_304 && ihigh_304 <= ihigh_296 && ihigh_296 < ihigh_288 && ihigh_288 > ihigh_280 && ihigh_280 > ihigh_272 && ihigh_272 < ihigh_264 && ilow_432 < ilow_424 && ilow_424 < ilow_416 && ilow_416 < ilow_408 && ilow_408 < ilow_400 && ilow_400 < ilow_392 && ilow_392 < ilow_384 && ilow_384 > ilow_376 && ilow_376 < ilow_368))) li_unused_0 = 0;
   int order_total_480 = OrdersTotal();
   for (int pos_484 = order_total_480 - 1; pos_484 >= 0; pos_484--) {
...
int start() {
   ...
   int count_1856 = 0;
   int order_total_1860 = 0;
   if (gi_1804 != Time[0]) {
      gi_1804 = Time[0];
      gi_1808++;
      count_1856 = 0;
      for (order_total_1860 = OrdersTotal(); order_total_1860 >= 0; order_total_1860--) {
         OrderSelect(order_total_1860, SELECT_BY_POS, MODE_TRADES);
   ...
   int order_total_3140 = OrdersTotal();
   li_3136 = 0;
   ...
   bool li_3792 = FALSE;
   for (int pos_3796 = max_trades; pos_3796 < order_total_3140; pos_3796++) {
   ...
   int order_total_3808 = OrdersTotal();
   for (int pos_3812 = order_total_3808 - 1; pos_3812 >= 0; pos_3812--) {
