...
//+------------------------------------------------------------------+
extern string Note1_____= "Magic Number Must be UNIQUE for each chart!";
extern string Note2_____= "EA must Run Equity 500: Lot=0.01 for 1 pair";
extern string Note3_____= "TF M5 or M15 in GBPUSD,EURUSD,EURGBP,USDJPY,USDCAD";
extern string Note4_____= "Contact me: lawrencetan92@hotmail.com";
string ExpiryDate="2026.06.26";
extern int TradeHr1From = 1;
extern int TradeHr1To   = 20;
extern int TradeHr2From = 20;
extern int TradeHr2To   = 24;
extern string t6 = " ----------------------------------------";
extern int OpenNewTF = 15;
extern double LotExponent = 1.25;
extern double slip = 50.0;
int gi_unused_88;
extern double Lots = 0.01;
extern int lotdecimal = 2;
extern double TakeProfit = 120;
extern double Stoploss   = 200.0;
extern double TrailStart = 20.0;
...
int result;
//========================================================================
extern string t2 = " EA2: Remedial Order";
extern int OpenNewTF_16 = 30;
extern double LotExponent_16 = 1.25;
extern double slip_16 = 50.0;
extern double Lots_16 = 0.01;
extern int lotdecimal_16 = 2;
extern double TakeProfit_16 = 120.0;
extern double Stoploss_16   = 200.0;
extern double TrailStart_16 = 20.0;
extern double TrailStop_16 = 10.0;
extern double PipStep_16 = 30.0;
extern int MaxTrades_16 = 10;
extern bool UseEquityStop_16 = false;
extern double TotalEquityRisk_16 = 50.0;
extern bool UseTrailingStop_16 = false;
bool UseTimeOut_16 = FALSE;
double MaxTradeOpenHours_16 = 24.0;
extern int g_magic_176_16 = 2222;
...
int start()
  {
  bool morningHours   = (Hour() >  TradeHr1From && Hour() < TradeHr1To),
     afternoonHours =  Hour() > TradeHr2From && Hour() < TradeHr2To,
     tradingHours   = morningHours || afternoonHours;
     if (!tradingHours) return(0);
     
     if(TimeCurrent() >= StrToTime(ExpiryDate)){
Alert("This indicator has expired. Contact lawrencetan92@hotmail.com for new version");
return(0);
}
...
//========================================================================//
   ...
   for (g_pos_300 = OrdersTotal() - 1; g_pos_300 >= 0; g_pos_300--) {
      result = OrderSelect(g_pos_300, SELECT_BY_POS, MODE_TRADES);
   ...
   if (gi_304 > 0 && gi_304 <= MaxTrades) {
      ...
      if (gi_320 && gd_236 - Ask >= PipStep*2 * Point) gi_316 = TRUE;
      if (gi_324 && Bid - gd_244 >= PipStep*2 * Point) gi_316 = TRUE;
   }
   if (gi_304 < 1) {
      gi_324 = FALSE;
      gi_320 = FALSE;
   ...
   if (gi_316) {
      ...
      gd_244 = FindLastSellPrice();
 //===================================================
 if ((0.01/500*AccountBalance())-Lots>0.01)
 { Lots=Lots+0.01;
 }
  //===================================================     
   ...
   {
   result = OrderSelect(total-1,SELECT_BY_POS,MODE_TRADES);
   if (OrderSymbol() != Symbol() || OrderMagicNumber() != g_magic_176) continue;
   if (OrderSymbol() == Symbol() && OrderMagicNumber() == g_magic_176) {
     orders++;
   }
...
//   double l_iclose_16;
   ...
   for (g_pos_300_16 = OrdersTotal() - 1; g_pos_300_16 >= 0; g_pos_300_16--) {
      result = OrderSelect(g_pos_300_16, SELECT_BY_POS, MODE_TRADES);
   ...
   if (gi_304_16 > 0 && gi_304_16 <= MaxTrades_16) {
      ...
      if (gi_320_16 && gd_236_16 - Ask >= PipStep_16*2 * Point) gi_316_16 = TRUE;
      if (gi_324_16 && Bid - gd_244_16 >= PipStep_16*2 * Point) gi_316_16 = TRUE;
   }
   if (gi_304_16 < 1) {
      gi_324_16 = FALSE;
      gi_320_16 = FALSE;
//      gi_316_16 = TRUE;
   ...
   if (gi_316_16) {
      ...
      gd_244_16 = FindLastSellPrice_16();
  //===================================================
 if ((0.01/500*AccountBalance())-Lots_16>0.01)
 { Lots_16=Lots_16+0.01;
 }
  //===================================================    
      if (gi_324_16) {
         gi_288_16 = gi_304_16;
   ...
   {
   result = OrderSelect(total_16-1,SELECT_BY_POS,MODE_TRADES);
   if (OrderSymbol() != Symbol() || OrderMagicNumber() != g_magic_176_16) continue;
   if (OrderSymbol() == Symbol() && OrderMagicNumber() == g_magic_176_16) {
     orders_16++;
   }
...
//      if (!gi_324_16 && !gi_320_16) {
         ...
         if (l_iclose_8/*_16*/ > l_iclose_16/*_16*/) {
            if (iRSI(NULL, PERIOD_H1, 14, PRICE_CLOSE, 1) < 49.0) {
            ...
            if (iRSI(NULL, PERIOD_H1, 14, PRICE_CLOSE, 1) > 51.0) {
...
int CountTrades() {
   ...
   for (int l_pos_4 = OrdersTotal() - 1; l_pos_4 >= 0; l_pos_4--) {
      result =OrderSelect(l_pos_4, SELECT_BY_POS, MODE_TRADES);
      if (OrderSymbol() != Symbol() || OrderMagicNumber() != g_magic_176) continue;
      if (OrderSymbol() == Symbol() && OrderMagicNumber() == g_magic_176)
...
void CloseThisSymbolAll() {
   for (int l_pos_0 = OrdersTotal() - 1; l_pos_0 >= 0; l_pos_0--) {
      result =OrderSelect(l_pos_0, SELECT_BY_POS, MODE_TRADES);
...
double FindLastBuyPrice() {
   ...
   for (int l_pos_16 = OrdersTotal() - 1; l_pos_16 >= 0; l_pos_16--) {
      result =OrderSelect(l_pos_16, SELECT_BY_POS, MODE_TRADES);
      if (OrderSymbol() != Symbol() || OrderMagicNumber() != g_magic_176) continue;
...
int CountTrades_16() {
   ...
   for (int l_pos_4_16 = OrdersTotal() - 1; l_pos_4_16 >= 0; l_pos_4_16--) {
      result =OrderSelect(l_pos_4_16, SELECT_BY_POS, MODE_TRADES);
      if (OrderSymbol() != Symbol() || OrderMagicNumber() != g_magic_176_16) continue;
      if (OrderSymbol() == Symbol() && OrderMagicNumber() == g_magic_176_16)
...
void CloseThisSymbolAll_16() {
   for (int l_pos_0_16 = OrdersTotal() - 1; l_pos_0_16 >= 0; l_pos_0_16--) {
      result =OrderSelect(l_pos_0_16, SELECT_BY_POS, MODE_TRADES);
      if (OrderSymbol() == Symbol()) {
         if (OrderSymbol() == Symbol() && OrderMagicNumber() == g_magic_176_16) {
...
double FindLastBuyPrice_16() {
   ...
   for (int l_pos_16_16 = OrdersTotal() - 1; l_pos_16_16 >= 0; l_pos_16_16--) {
      result = OrderSelect(l_pos_16_16, SELECT_BY_POS, MODE_TRADES);
      if (OrderSymbol() != Symbol() || OrderMagicNumber() != g_magic_176_16) continue;
