//+------------------------------------------------------------------+
//|                                 58.Blazer_Robot_modified (3).mq4 |
...
*/
#property copyright "Blazer Robot"
#property link      "mailto:susanto.andi@gmail.com"

extern bool blazer1=true;
extern bool blazer2=true;
extern bool blazer3=FALSE;
extern string t1 = "SETTINGS";
extern double Lots = 0.01;
extern double LotExponent = 1.11;
...
int init() {
   ...
   g_text_1104 = "lord_steven1@yahoo.com";
...
int start() {
   ...
   Comment("mail to: susanto.andi@gmail.com" 
      + "\n" 
      + "Blazer Robot" 
      + "\n" 
      ...
      + "\n" 
      + "Open Orders Blazer1:   " + CountTrades_Hilo() 
      + "\n" 
      + "Open Orders Blazer2:   " + CountTrades_15() 
      + "\n" 
      + "Open Orders Blazer3:   " + CountTrades_16() 
      + "\n" 
   ...
   ObjectSetText("Lable3", "Account EQUITY:  " + g_dbl2str_1120 + "", 16, "Times New Roman", g_color_1128);
   ...
   bool l_bool_1080 = UseEquityStop;
   double ld_1084 = TotalEquityRisk;
   bool l_bool_1092 = UseTrailingStop;
   ...
   if (l_bool_1092) TrailingAlls_Hilo(ld_1096, ld_1104, g_price_264);
   if (gi_184) {
   ...
   if (gi_360) {
      ...
      if (gi_368&&blazer1) {
         ...
         RefreshRates();
         gi_372 = OpenPendingOrder_Hilo(1, gd_336, Bid, ld_1120, Ask, 0, 0, gs_blazer1_316 + "-" + gi_332, MagicNumber_Hilo, 0, HotPink);
         if (gi_372 < 0) {
         ...
         if (gi_364&&blazer1) {
            gi_332 = gi_348;
            gd_336 = NormalizeDouble(ld_144 * MathPow(ld_1060, gi_332), li_1068);
            gi_372 = OpenPendingOrder_Hilo(0, gd_336, Ask, ld_1120, Bid, 0, 0, gs_blazer1_316 + "-" + gi_332, MagicNumber_Hilo, 0, Lime);
            if (gi_372 < 0) {
               Print("Error: ", GetLastError());
               return (0);
            }
      ...
      if (!gi_368 && !gi_364) {
         ...
         if (l_ihigh_112 > l_ilow_120) {
            if (iRSI(NULL, PERIOD_H1, 14, PRICE_CLOSE, 1) > 30.0) {
               gi_372 = OpenPendingOrder_Hilo(1, gd_336, g_bid_272, ld_1120, g_bid_272, 0, 0, gs_blazer1_316 + "-" + gi_332, MagicNumber_Hilo, 0, HotPink);
               if (gi_372 < 0) {
                  Print("Error: ", GetLastError());
                  return (0);
               }
            ...
            if (iRSI(NULL, PERIOD_H1, 14, PRICE_CLOSE, 1) < 70.0) {
               gi_372 = OpenPendingOrder_Hilo(0, gd_336, g_ask_280, ld_1120, g_ask_280, 0, 0, gs_blazer1_316 + "-" + gi_332, MagicNumber_Hilo, 0, Lime);
               if (gi_372 < 0) {
                  Print("Error: ", GetLastError());
                  return (0);
               }
   ...
   bool l_bool_1164 = UseEquityStop;
   double ld_1168 = TotalEquityRisk;
   bool l_bool_1176 = UseTrailingStop;
   ...
   if (l_bool_1176) TrailingAlls_15(ld_1180, ld_1188, g_price_476);
   if (gi_420) {
   ...
   if (gi_536 != Time[0]) {
      ...
      if (gi_572&&blazer2) {
         ...
         if (gi_580) {
            ...
            RefreshRates();
            gi_584 = OpenPendingOrder_15(1, gd_548, Bid, ld_1204, Ask, 0, 0, gs_blazer2_528 + "-" + gi_544, g_magic_176_15, 0, HotPink);
            if (gi_584 < 0) {
               Print("Error: ", GetLastError());
               return (0);
            }
            ...
            if (gi_576&&blazer2) {
               gi_544 = gi_560;
               gd_548 = NormalizeDouble(ld_152 * MathPow(ld_1144, gi_544), li_1152);
               gi_584 = OpenPendingOrder_15(0, gd_548, Ask, ld_1204, Bid, 0, 0, gs_blazer2_528 + "-" + gi_544, g_magic_176_15, 0, Lime);
               if (gi_584 < 0) {
                  Print("Error: ", GetLastError());
                  return (0);
               }
   ...
   if (g_datetime_608 != iTime(NULL, g_timeframe_408, 0)) {
      ...
      for (int li_1212 = l_ord_total_168; li_1212 >= 1; li_1212--) {
         OrderSelect(li_1212 - 1, SELECT_BY_POS, MODE_TRADES);
         if (OrderSymbol() != Symbol() || OrderMagicNumber() != g_magic_176_15) continue;
      ...
      if (l_ord_total_168 == 0 || l_count_172 < 1&&blazer2) {
         ...
         if (l_iclose_128 > l_iclose_136) {
            gi_584 = OpenPendingOrder_15(1, gd_548, g_bid_484, ld_1204, g_bid_484, 0, 0, gs_blazer2_528 + "-" + gi_544, g_magic_176_15, 0, HotPink);
            if (gi_584 < 0) {
               Print("Error: ", GetLastError());
               return (0);
            }
            ...
            gi_584 = OpenPendingOrder_15(0, gd_548, g_ask_492, ld_1204, g_ask_492, 0, 0, gs_blazer2_528 + "-" + gi_544, g_magic_176_15, 0, Lime);
            if (gi_584 < 0) {
               Print("Error: ", GetLastError());
               return (0);
            }
   ...
   bool l_bool_1244 = UseEquityStop;
   double ld_1248 = TotalEquityRisk;
   bool l_bool_1256 = UseTrailingStop;
   ...
   if (l_bool_1256) TrailingAlls_16(ld_1260, ld_1268, g_price_692);
   if (gi_636) {
   ...
   if (gi_752 != Time[0]) {
      ...
      for (g_pos_772 = OrdersTotal() - 1; g_pos_772 >= 0; g_pos_772--) {
         OrderSelect(g_pos_772, SELECT_BY_POS, MODE_TRADES);
      ...
      if (gi_788) {
         ...
         if (gi_796&&blazer3) {
            ...
            RefreshRates();
            gi_800 = OpenPendingOrder_16(1, gd_764, Bid, ld_1284, Ask, 0, 0, gs_blazer3_744 + "-" + gi_760, g_magic_176_16, 0, HotPink);
            if (gi_800 < 0) {
               Print("Error: ", GetLastError());
               return (0);
            }
            ...
            if (gi_792&&blazer3) {
               gi_760 = gi_776;
               gd_764 = NormalizeDouble(ld_176 * MathPow(ld_1224, gi_760), li_1232);
               gi_800 = OpenPendingOrder_16(0, gd_764, Ask, ld_1284, Bid, 0, 0, gs_blazer3_744 + "-" + gi_760, g_magic_176_16, 0, Lime);
               if (gi_800 < 0) {
                  Print("Error: ", GetLastError());
                  return (0);
               }
   ...
   if (g_datetime_824 != iTime(NULL, g_timeframe_624, 0)) {
      ...
      for (int li_1292 = l_ord_total_192; li_1292 >= 1; li_1292--) {
         OrderSelect(li_1292 - 1, SELECT_BY_POS, MODE_TRADES);
         if (OrderSymbol() != Symbol() || OrderMagicNumber() != g_magic_176_16) continue;
      ...
      if (l_ord_total_192 == 0 || l_count_196 < 1&&blazer3) {
         ...
         if (l_iclose_128 > l_iclose_136) {
            if (iRSI(NULL, PERIOD_H1, 14, PRICE_CLOSE, 1) > 30.0) {
               gi_800 = OpenPendingOrder_16(1, gd_764, g_bid_700, ld_1284, g_bid_700, 0, 0, gs_blazer3_744 + "-" + gi_760, g_magic_176_16, 0, HotPink);
               if (gi_800 < 0) {
                  Print("Error: ", GetLastError());
                  return (0);
               }
            ...
            if (iRSI(NULL, PERIOD_H1, 14, PRICE_CLOSE, 1) < 70.0) {
               gi_800 = OpenPendingOrder_16(0, gd_764, g_ask_708, ld_1284, g_ask_708, 0, 0, gs_blazer3_744 + "-" + gi_760, g_magic_176_16, 0, Lime);
               if (gi_800 < 0) {
                  Print("Error: ", GetLastError());
                  return (0);
               }
...
void CloseThisSymbolAll_Hilo() {
   for (int l_pos_0 = OrdersTotal() - 1; l_pos_0 >= 0; l_pos_0--) {
      ...
      if (OrderSymbol() == Symbol()) {
         if (OrderSymbol() == Symbol() && OrderMagicNumber() == MagicNumber_Hilo) {
            if (OrderType() == OP_BUY) OrderClose(OrderTicket(), OrderLots(), Bid, g_slippage_204, Blue);
            if (OrderType() == OP_SELL) OrderClose(OrderTicket(), OrderLots(), Ask, g_slippage_204, Red);
         }
         Sleep(1000);
      }
   }
...
void CloseThisSymbolAll_15() {
   for (int l_pos_0 = OrdersTotal() - 1; l_pos_0 >= 0; l_pos_0--) {
      ...
      if (OrderSymbol() == Symbol()) {
         if (OrderSymbol() == Symbol() && OrderMagicNumber() == g_magic_176_15) {
            if (OrderType() == OP_BUY) OrderClose(OrderTicket(), OrderLots(), Bid, g_slippage_432, Blue);
            if (OrderType() == OP_SELL) OrderClose(OrderTicket(), OrderLots(), Ask, g_slippage_432, Red);
         }
         Sleep(1000);
      }
   }
...
void CloseThisSymbolAll_16() {
   for (int l_pos_0 = OrdersTotal() - 1; l_pos_0 >= 0; l_pos_0--) {
      ...
      if (OrderSymbol() == Symbol()) {
         if (OrderSymbol() == Symbol() && OrderMagicNumber() == g_magic_176_16) {
            if (OrderType() == OP_BUY) OrderClose(OrderTicket(), OrderLots(), Bid, g_slippage_648, Blue);
            if (OrderType() == OP_SELL) OrderClose(OrderTicket(), OrderLots(), Ask, g_slippage_648, Red);
         }
         Sleep(1000);
      }
   }
