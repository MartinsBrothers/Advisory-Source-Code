//+------------------------------------------------------------------+
//|                                     46.ASSAR_V10Conservative.mq4 |
//|                        Copyright 2020, MetaQuotes Software Corp. |
//|                                             https://www.mql5.com |
//+------------------------------------------------------------------+
//+------------------------------------------------------------------+
//|ASSARV10 by www.assarv9.com 
//|                                                                  |
//|   
//+------------------------------------------------------------------+
#property strict
...
//|                                                                  |
//+------------------------------------------------------------------+
extern string  Contact = "ASSARV10 www.assarofficial.com";
...
extern string  Currency = "Any currency pair less than 2 pips";
extern bool    mm = TRUE;
...
input int                     BeforeEventsInMinutes         = 1;
input int                     AfterEventsInMinutes          = 1;
...
input bool                    IncludeMedium                 = false;
...
input bool                    IncludeSpeaks                 = false;
...
string COMMENT = "ASSARV10 www.assarofficial.com";
bool AUTOMM = mm;
