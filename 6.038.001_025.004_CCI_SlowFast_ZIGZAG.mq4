//+------------------------------------------------------------------+
//|                        6.038.001_025.004_CCI_SlowFast_ZIGZAG.mq4 |
...
//   int      _TIMEFRAME_2   = getHigherTimeframe(getHigherTimeframe(_TIMEFRAME));
   ...
   double   result         = 0;
   double   CCISlow0, CCISlow1, CCISlow2, CCIFast0, CCIFast1, CCIFast2;
...
//            break;
         ...
         CCISlow0 = iCCI(_SYMBOL, _TIMEFRAME, _SLOW, _PRICE, _SHIFT);
         CCIFast0 = iCCI(_SYMBOL, _TIMEFRAME, _FAST, _PRICE, _SHIFT);
         CCISlow1 = iCCI(_SYMBOL, _TIMEFRAME, _SLOW, _PRICE, _SHIFT+1);
         CCIFast1 = iCCI(_SYMBOL, _TIMEFRAME, _FAST, _PRICE, _SHIFT+1);
         CCISlow2 = iCCI(_SYMBOL, _TIMEFRAME, _SLOW, _PRICE, _SHIFT+2);
         CCIFast2 = iCCI(_SYMBOL, _TIMEFRAME, _FAST, _PRICE, _SHIFT+2);
         ...
         switch(_OPEN_SIGNAL_COMBINATION)
         {
            case 1:
            {
               if(CCIFast0 > CCISlow0)
               if(CCIFast1 < CCISlow1)
...
//            break;
         ...
         switch(_CLOSE_SIGNAL_COMBINATION)
         {
            case 1:
            {
//               if(CCIFast0 - CCISlow0 < CCIFast1 - CCISlow1)
               if(CCIFast0 < CCISlow0)
                  result = 1;
...
//            break;
         ...
         switch(_CLOSE_SIGNAL_COMBINATION)
         {
            case 1:
            {
//               if(CCISlow0 - CCIFast0 < CCISlow1 - CCIFast1)
               if(CCIFast0 > CCISlow0)
                  result = 1;
